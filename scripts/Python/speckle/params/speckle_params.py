...
def load_dataset():
	iter_paths = ["../../../../datasets/Berkeley/speckle"]#, "../../../../datasets/Pascal/speckle"]
	...
	np.save('np_data/train_images_speckle.npy', train_images)
	np.save('np_data/train_labels_speckle.npy', train_labels)
	del(train_images)
	del(train_labels)

	iter_path = "../../../../datasets/USC/speckle"
	...
	np.save('np_data/test_images_speckle.npy', test_images)
	np.save('np_data/test_labels_speckle.npy', test_labels)
	del(test_images)
	del(test_labels)

def train():
	train_images = np.load('np_data/train_images_speckle.npy')
	train_labels = np.load('np_data/train_labels_speckle.npy')
	...
	model.save('models/speckle.h5')
	del(train_images)
	del(train_labels)

# def train_v():
# 	train_images = np.load('np_data/train_images_speckle.npy')
# 	train_labels_v = np.load('np_data/train_labels_v_speckle.npy')
...
# 	model.save('models/speckle_v.h5')
# 	del(train_images)
# 	del(train_labels_v)

def test():
	test_images = np.load('np_data/test_images_speckle.npy')
	test_labels = np.load('np_data/test_labels_speckle.npy')

	model = models.load_model('models/speckle.h5')
